...
[![stable](http://poser.pugx.org/sofyco/wordpress-gateway-bundle/v)](https://packagist.org/packages/sofyco/wordpress-gateway-bundle)

## Installation

```bash
composer req sofyco/wordpress-gateway-bundle
```
